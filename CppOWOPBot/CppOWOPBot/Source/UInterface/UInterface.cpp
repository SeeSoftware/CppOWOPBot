...
void UInterface::DrawGui()
{
	...
	//HACK:PUT ME AFTER DRAWING GUI TO FIX SFML STUFF
	EndFullscreen();
	...
	if (ImGui::Begin("Bot Manager"))
	{
		...
		if (ImGui::Button("Add"))
		{	//http://vikasowop.000webhostapp.com/app.js
			mManager.Connect("ws://vikaowopserver.herokuapp.com", botAmmount, useProxy, updaterBot); //ws://104.237.150.24:1337 //wss://ourworldofpixels.com //ws://desmecito.herokuapp.com // "ws://vikaowopserver.herokuapp.com"
		}
		ImGui::SameLine();
